...
ml_path = raw"C:\Users\ellio\git\gcn-dmpc\final-analysis\last-8-decompositions\ML-preds-GCN-floats.csv"
...
d7_path = raw"C:\Users\ellio\git\gcn-dmpc\supervised-edge-prediction\perfect-dmpc7.csv"
d8_path = raw"C:\Users\ellio\git\gcn-dmpc\supervised-edge-prediction\perfect-dmpc8.csv"

weights_path = raw"C:\Users\ellio\git\gcn-dmpc\final-analysis\last-8-decompositions\edge-weights-210.csv"

out_scores_path = raw"C:\Users\ellio\git\gcn-dmpc\final-analysis\last-8-decompositions\ML-weighted-bernoulli-loglik-scores-GCN-floats.csv"
out_pred_path   = raw"C:\Users\ellio\git\gcn-dmpc\final-analysis\last-8-decompositions\ML-weighted-bernoulli-predicted-arch-GCN-floats.csv"
...
d7 = vec(Matrix(CSV.read(d7_path, DataFrame; header=false)))
d8 = vec(Matrix(CSV.read(d8_path, DataFrame; header=false)))
templates = [Float64.(d1), Float64.(d2), Float64.(d3), Float64.(d4), Float64.(d5), Float64.(d6), Float64.(d7), Float64.(d8)]
...
# Predicted architecture = argmax score (1..8)
